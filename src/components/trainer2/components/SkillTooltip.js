...
import {uiTextSelector, constantSelector, statSelector, skillNameRefSelector, skillIconRefSelector, templateSelector, buildSelector, currentElementSelector} from '../selector'
...
const SkillTooltip = (props) => {
    ...
    let thisType = props.type
    let thisTypeArr = thisType.split('-')

    let currentTooltip = props.tooltipData.getIn([currentTypeArr[0], currentTypeArr.length > 1 ? 'hmTraits' : 'traits'])
    let thisTooltip = props.tooltipData.getIn([thisTypeArr[0], thisTypeArr.length > 1 ? 'hmTraits' : 'traits'])
        ...
        <div className='skillTooltip'>
            <div className='topBlock'>
                <h3 className='name'>
                    ...
                    <small className='classification'>{thisTypeArr[0], thisTypeArr.length > 1 ? props.uiText.get('hm') : ''}</small>
